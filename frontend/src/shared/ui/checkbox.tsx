...
>(({ className, ...props }, ref) => (
    <CheckboxPrimitive.Root
        ref={ref}
        className={cn(
            'peer flex h-5 w-5 shrink-0 items-center justify-center rounded border border-[var(--neutral-300)] bg-[var(--background)] transition-colors',
            ...
            'data-[state=checked]:text-[var(--text-white)]',
            className,
        )}
        {...props}
    >
